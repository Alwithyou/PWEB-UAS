  ...
  <div class="w-full max-w-2xl bg-white text-stone-800 shadow-2xl rounded-3xl p-8 border border-stone-300">
    ...
    <div class="space-y-4 text-sm sm:text-base">
      ...
      <div class="flex items-start gap-3">
        <iconify-icon icon="icon-park-outline:home" class="text-amber-500 text-xl mt-1"></iconify-icon>
    ...
    <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
      <a href="{{ route('user.profil.edit') }}"
        ...
        <iconify-icon icon="icon-park-outline:" class="inline-block mr-2 text-xl"></iconify-icon>Edit Profil
      </a>
      <a href="{{ route('user.dashboard') }}"
        ...
        <iconify-icon icon="icon-park-outline:" class="inline-block mr-2 text-xl"></iconify-icon>Kembali
      </a>
    </div>
  </div>
